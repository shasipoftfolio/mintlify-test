...
<AccordionGroup>
  ...
  <Accordion title="Order Monitoring">
...
<AccordionGroup>
  <Accordion title="Centralized Dashboard">
  ...
  <Accordion title="Location Groups">
  ...
  <Accordion title="Recipe Distribution">
  ...
  <Accordion title="Inventory Transfers">
...
<CardGroup cols={2}>
  <Card title="Enterprise Documentation" icon="book">
    Comprehensive guides for enterprise features
  </Card>
  <Card title="Dedicated Account Manager" icon="user-tie">
    Personal contact for enterprise customers
  </Card>
  <Card title="Professional Services" icon="screwdriver-wrench">
    Custom development and integration services
  </Card>
  <Card title="Training Programs" icon="graduation-cap">
    On-site and virtual training for your team
  </Card>
  <Card title="24/7 Support" icon="phone">
    Enterprise support available around the clock
  </Card>
</CardGroup>
