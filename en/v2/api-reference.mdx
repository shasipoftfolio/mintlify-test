...
<CardGroup cols={3}>
  ...
  <Card title="Professional Plan" icon="circle-half-stroke">
    10,000 requests per hour
  </Card>
  <Card title="Enterprise Plan" icon="circle-dot">
...
<CardGroup cols={2}>
  <Card title="Inventory Management" icon="boxes-stacked" href="#inventory-management">
    Manage salsa ingredients, track stock levels, and monitor freshness.
  </Card>
  <Card title="Recipe Management" icon="book-open" href="#recipe-management">
  ...
  <Card title="Analytics & Reporting" icon="chart-bar" href="#analytics-reporting">
...
<CardGroup cols={2}>
  <Card title="ingredient.low_stock" icon="triangle-exclamation">
    When ingredient stock falls below threshold
  </Card>
  <Card title="production.batch_completed" icon="circle-check">
    When a production batch is completed
  </Card>
  <Card title="quality.alert" icon="shield-exclamation">
    When quality scores fall below acceptable levels
  </Card>
  <Card title="inventory.expiry_warning" icon="clock">
